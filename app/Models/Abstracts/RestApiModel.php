...
abstract class RestApiModel extends Model
{
    ...
    protected static $defaultResponseResolverClass = JavaRestResponseResolver::class;
    protected static $responseResolverClass = null;
    protected static $responseResolver = null;
    ...
    {
        if (is_null(static::$responseResolver)) {
            static::createResponseResolver();
        }
        return static::$responseResolver;
    }

    protected static function createResponseResolver()
    {
        if (is_null(static::$responseResolverClass)) {
            static::$responseResolverClass = static::$defaultResponseResolverClass;
        }
        $resolver = new static::$responseResolverClass;
